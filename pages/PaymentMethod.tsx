      ...
      <div className="px-4 md:px-6 lg:px-12 mt-6 md:mt-8 flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div style={{ display: 'none' }} className="bg-white rounded-xl shadow-sm overflow-hidden lg:sticky lg:top-24">
            ...
            <div className="bg-green-600 px-6 py-4 flex items-center gap-3 text-white border-b border-green-700">
              <svg
                width="20"
                height="20"
                viewBox="0 0 17 17"
              ...
              <span className="text-base font-semibold">Buy / Sell Crypto</span>
            </div>
            ...
            <nav className="p-4 space-y-2">
              {[
                ...
                <button
                  key={item.label}
                  className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200"
                >
            ...
            <div className="border-t border-gray-200 p-4">
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-900 text-sm font-medium transition-colors">
                <span>Logout</span>
                <svg
                  width="14"
                  height="14"
        ...
        <div className="w-full lg:w-80 flex-shrink-0 hidden lg:block">
          <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-24">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="px-3 py-1.5 bg-gray-900 text-white text-xs font-semibold rounded-lg hover:bg-gray-800 transition-colors">
                View All
              </button>
            </div>
